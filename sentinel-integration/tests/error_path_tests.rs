...
//!
//! These tests verify Sentinel's fail-closed behavior and concurrency safety
...
mod idempotency_concurrency {
    use super::*;
    use sentinel_server::idempotency::{IdempotencyConfig, IdempotencyStore};
            ...
            .map(|_| {
                ...
                tokio::spawn(async move {
                    match s.try_acquire("same-key") {
                        ...
                        Err(sentinel_server::idempotency::IdempotencyError::InProgress) => {
