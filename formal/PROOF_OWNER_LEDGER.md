...
| Broader audit chain kernel | [`vellaveto-audit/src/verification.rs`](/home/paolo/.vella-workspace/sentinel/vellaveto-audit/src/verification.rs) | P4 (per-entry verification guard landed; append-only growth and filesystem assumptions still pending) |
