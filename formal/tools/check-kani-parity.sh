...
check_symbol_parity "capability child-glob guard" "$PROD_CAPABILITY" "verified_capability_pattern::pattern_subset_guard" "$KANI_DIR/capability.rs" "pub[[:space:]]+fn[[:space:]]+pattern_subset_guard"
