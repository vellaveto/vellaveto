...
> **State:** v4.0.0-dev (Phases 1–25.1/25.2/25.6 + 26 + 27 + 29 + 30 + 33 + 34 + 35 + 37 + 38 + 39 + 40 + 41 + 43 + 44 + 47 + 48 + 49 complete, 222 audit rounds)
> **Version:** 4.0.0-dev
> **License:** AGPL-3.0 dual license (see LICENSING.md)
> **Tests:** 7,690 Rust tests + 385 Python SDK tests + 127 Go SDK tests + 119 TypeScript SDK tests, zero warnings, zero `unwrap()` in library code
> **Fuzz targets:** 24
...
All 24 phases + Phase 25 (sub-phases 25.1/25.2/25.6) + Phase 26 + Phase 27 + Phase 29 + Phase 30 + Phase 33 + Phase 34 + Phase 35 + Phase 37 + Phase 38 + Phase 40 + Phase 41 + Phase 43 + Phase 44 + Phase 47 + Phase 48 + Phase 49 implemented, tested, and hardened through 222 audit rounds. Details in CHANGELOG.md.
