...
use sentinel_config::GatewayConfig;
use sentinel_types::{BackendHealth, RoutingDecision, ToolConflict};
...
pub fn spawn_health_checker(
    ...
    tokio::spawn(async move {
        ...
        loop {
            ...
            metrics::gauge!("sentinel_gateway_backends_total").set(total as f64);
            metrics::gauge!("sentinel_gateway_backends_healthy").set(healthy_count as f64);
        }
    })
}
...
mod tests {
    use super::*;
    use sentinel_config::{BackendConfig, GatewayConfig};
