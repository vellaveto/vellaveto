    ...
    use super::call_chain::{
        build_audit_context, build_current_agent_entry,
        call_chain_entry_signing_content, compute_call_chain_hmac,
        extract_call_chain_from_headers, jsonrpc_id_key, take_tracked_tool_call,
        track_pending_tool_call, sync_session_call_chain_from_headers,
        validate_call_chain_header, verify_call_chain_hmac,
        MAX_ACTION_HISTORY, MAX_CALL_COUNT_TOOLS, MAX_PENDING_TOOL_CALLS,
    };
