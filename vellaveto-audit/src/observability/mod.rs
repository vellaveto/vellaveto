...
//! ```toml
//! vellaveto-audit = { version = "2.0", features = ["observability-exporters"] }
//! ```
...
impl From<&vellaveto_types::Action> for ActionSummary {
    fn from(action: &vellaveto_types::Action) -> Self {
        Self {
...
impl SecuritySpanBuilder {
    ...
    /// Set the action from a vellaveto Action.
    pub fn action_from(mut self, action: &vellaveto_types::Action) -> Self {
    ...
    /// Set the verdict from a vellaveto Verdict.
...
///
/// ```
/// use vellaveto_audit::observability::RedactionConfig;
///
