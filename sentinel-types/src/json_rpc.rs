//! JSON-RPC 2.0 error codes for Sentinel.
//!
//! This module provides constants for standard JSON-RPC 2.0 error codes
//! and Sentinel-specific application error codes in the reserved range.
//!
...
//!
//! Sentinel uses the reserved range for security-specific error conditions.
...
// ═══════════════════════════════════════════════════════════════════════════════
// Sentinel Application Error Codes (-32000 to -32099)
// ═══════════════════════════════════════════════════════════════════════════════
