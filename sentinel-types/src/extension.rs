...
//!
//! Extensions allow third-party capabilities to be registered with Sentinel
...
pub struct ExtensionDescriptor {
    /// Unique extension identifier (e.g., "sentinel-audit").
    ...
    /// Methods this extension handles (e.g., `["x-sentinel-audit/query"]`).
    #[serde(default)]
