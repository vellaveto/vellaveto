...
pub fn build_router(state: AppState) -> Router {
    ...
    let authenticated = Router::new()
        ...
        .route("/api/etdi/pins/{tool}", post(create_version_pin))
        .route("/api/etdi/pins/{tool}", delete(remove_version_pin))
        // ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════════
// Phase 8: ETDI Cryptographic Tool Security Handlers
// ═══════════════════════════════════════════════════════════════════════════════

/// List all tool signatures.
async fn list_tool_signatures(
...
async fn get_tool_attestations(
    State(state): State<crate::AppState>,
    Path(tool): Path<String>,
) -> Result<Json<serde_json::Value>, (StatusCode, Json<serde_json::Value>)> {
    let Some(ref store) = state.etdi_store else {
