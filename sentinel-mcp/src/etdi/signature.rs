...
//! tool definitions, and Sentinel verifies signatures before allowing registration.
//!
//! # Security
//!
...
use sentinel_types::{SignatureAlgorithm, SignatureVerification, ToolSignature};
