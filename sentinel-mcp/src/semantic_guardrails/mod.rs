...
//!
//! This module provides LLM-based semantic guardrails for Sentinel, enabling:
//!
...
//!
//! ```rust,ignore
//! use sentinel_mcp::semantic_guardrails::{
...
//! # Fail-Closed Design
//!
//! Following Sentinel's security principles, semantic guardrails are fail-closed:
//!
