...
//! ```toml
//! [dependencies]
//! sentinel-mcp = { version = "2.0", features = ["a2a"] }
//! ```
...
pub use agent_card::{
    build_agent_card_url, parse_agent_card, supports_auth_scheme, supports_streaming,
    validate_agent_card, validate_request_method, AgentCapabilities, AgentCard, AgentCardCache,
    AgentSkill, AuthScheme, AuthenticationInfo, ProviderInfo,
};
