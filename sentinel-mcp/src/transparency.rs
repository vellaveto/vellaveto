...
//! 1. **Transparency marking** — Injects `_meta.sentinel_ai_mediated: true`
...
///
/// Adds `result._meta.sentinel_ai_mediated = true` if the message
...
mod tests {
    ...
    fn test_mark_ai_mediated_adds_meta() {
        ...
        assert_eq!(
            msg["result"]["_meta"]["sentinel_ai_mediated"],
            serde_json::Value::Bool(true)
        );
    }
