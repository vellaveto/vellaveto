...
//!
//! ```rust,ignore
//! use vellaveto_mcp::semantic_guardrails::backends::MockEvaluator;
//! use vellaveto_mcp::semantic_guardrails::evaluator::{LlmEvaluator, LlmEvalInput};
//! use vellaveto_mcp::semantic_guardrails::intent::Intent;
//!
//! #[tokio::main]
//! async fn main() {
...
//!         vellaveto_mcp::semantic_guardrails::evaluator::LlmEvaluation::deny("File deletion not allowed")
//!     });
//!
