...
//! # Fail-Closed Design
//!
//! Following Vellaveto's security principles, RAG defense is fail-closed:
//!
...
use vellaveto_config::RagDefenseConfig;
...
mod tests {
    ...
    fn test_service_document_verification() {
        let config = RagDefenseConfig {
            enabled: true,
            document_verification: vellaveto_config::DocumentVerificationConfig {
                enabled: true,
    ...
    fn test_service_retrieval_inspection() {
        let config = RagDefenseConfig {
            enabled: true,
            retrieval_security: vellaveto_config::RetrievalSecurityConfig {
                enabled: true,
    ...
    fn test_service_embedding_check() {
        let config = RagDefenseConfig {
            enabled: true,
            embedding_anomaly: vellaveto_config::EmbeddingAnomalyConfig {
                enabled: true,
    ...
    fn test_service_budget_check() {
        let config = RagDefenseConfig {
            enabled: true,
            context_budget: vellaveto_config::ContextBudgetConfig {
                enabled: true,
