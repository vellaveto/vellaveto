...
By submitting a contribution (pull request, patch, or other code) to this project,
you agree to license your contribution under the AGPL-3.0, and you grant the project
maintainers a perpetual, worldwide, non-exclusive, royalty-free license to use,
reproduce, modify, sublicense, and distribute your contribution under any license,
including the commercial license described above.

This is necessary to maintain the dual-licensing model that funds development.
A formal Contributor License Agreement (CLA) will be provided via CLA Assistant
