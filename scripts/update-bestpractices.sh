...
FIELDS=(
  ...
  "roles_responsibilities_status|Met|CONTRIBUTING.md defines contributor/maintainer roles. CLAUDE.md documents development rules.|silver"
  ...
  "documentation_architecture_status|Met|CLAUDE.md contains detailed architecture section with crate dependency graph, key types, and file locations.|silver"
  ...
  "documentation_current_status|Met|Documentation actively maintained, updated with every release. CLAUDE.md updated 2026-03-01.|silver"
  ...
  "coding_standards_status|Met|CLAUDE.md and .claude/rules/ define comprehensive coding standards: no unwrap, fail-closed, test naming, commit format.|silver"
  ...
  "implement_secure_design_status|Met|Fail-closed design (errors produce Deny). Defense in depth. Zero trust. Documented in CLAUDE.md and docs/SECURITY.md.|silver"
