...
files establishing 21 theorems (no \texttt{sorry} markers), eight Coq proof
files establishing 27 theorems (no \texttt{Admitted} markers), and nine Kani
...
\begin{enumerate}
  ...
  \item Lean~4 proofs (21 theorems across 5 files) and Coq proofs (27
...
\begin{description}
  ...
  \item[Lean~4 (unbounded proof assistant)] Interactive theorem prover.
    21 theorems across 5 files with zero \texttt{sorry} markers. Covers
  ...
  \item[Coq (unbounded proof assistant)] Interactive theorem prover.
    27 theorems across 8 files with zero \texttt{Admitted} markers.
...
\begin{itemize}
  ...
  \item \textbf{Lean~4:} 5 files, 21 theorems. Zero \texttt{sorry} markers.
    All proofs complete via structural induction or reflexivity.
  \item \textbf{Coq:} 8 files, 27 theorems. Zero \texttt{Admitted} markers.
...
Theorem proving & Lean~4 & 21 theorems \\
Theorem proving & Coq & 27 theorems \\
